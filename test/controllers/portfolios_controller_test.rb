...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post portfolios_url, params: { portfolio: { price: @portfolio.price, shares: @portfolio.shares, ticker: @portfolio.ticker, user_id: @portfolio.user_id } }
    end
  ...
  test "should update portfolio" do
    patch portfolio_url(@portfolio), params: { portfolio: { price: @portfolio.price, shares: @portfolio.shares, ticker: @portfolio.ticker, user_id: @portfolio.user_id } }
